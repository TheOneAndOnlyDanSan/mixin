...
public class MixinTransformer implements ClassFileTransformer {
    ...
    public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) {
        ...
        if(classBeingRedefined.isAnnotationPresent(Mixin.class)) {
            ...
            classfileBuffer = MixinByteManipulator.getMixinedClass(classBeingRedefined, classfileBuffer);
        }
        if(Agent.mixinClasses.containsKey(classBeingRedefined)) {
            classfileBuffer = TargetByteManipulator.getMixinedClass(classBeingRedefined, classfileBuffer);
        }
